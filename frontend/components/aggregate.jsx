    ...
    <div className="Aggreagate">
      ...
      <div className="txt-input">
        <div className="txt-input-2col">
          ...
          <input type="text" id="effDate" value={this.effDate} valueLink={this.linkState('effDate')}/>
        </div>
        <div className="txt-input-2col">
        ...
        <div className="txt-input-2col">
          ...
          <input type="text" id="insName" value={this.insName} valueLink={this.linkState('insName')}/>
          <label htmlfor="agent">Agent</label>
          <input type="text" id="agent" valueLink={this.linkState('agent')}/>
        </div>
        <div className="txt-input-2col">
          <label htmlfor="garAddr">Primary Garage Address</label>
          <input type="text" id="garAddr" value={this.garAddr} valueLink={this.linkState('garAddr')}/>
